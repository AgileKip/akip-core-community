 ...
 */
@RestController
@RequestMapping("/api/public/{accessToken}")
public class NotePublicController {

    private final Logger log = LoggerFactory.getLogger(NotePublicController.class);
    ...
    public NotePublicController(NoteService noteService) {
        this.noteService = noteService;
    }

    @PostMapping("/notes")
    public ResponseEntity<Void> create(@PathVariable String accessToken, @RequestBody NoteDTO noteDTO) throws URISyntaxException {
    ...
    @PutMapping("/notes")
    public ResponseEntity<Void> update(@PathVariable String accessToken, @RequestBody NoteDTO noteDTO) throws URISyntaxException {
    ...
    public ResponseEntity<NoteDTO> get(@PathVariable String accessToken, @PathVariable("noteId") Long noteId) {
    ...
    public ResponseEntity<Void> delete(@PathVariable String accessToken, @PathVariable("noteId") Long noteId) {
        log.debug("REST request to get note: {}", noteId);
    ...
    public List<NoteDTO> getNotesByEntityNameAndEntityId(
            @PathVariable String accessToken,
            @PathVariable String entityName,
            @PathVariable Long entityId
    ) { log.debug("REST request to getNotesByEntityNameAndEntitiesIds: entityName={}, entitiesIds={}", entityName, entityId);
        return noteService.findByEntityNameAndEntityId(entityName, entityId);
    }

    @GetMapping("/{entityName}/{entityId}/{noteTypes}/notes")
    public List<NoteDTO> getNotesByEntityNameAndEntityIdAndTypes(
            @PathVariable String accessToken,
            @PathVariable String entityName,
            @PathVariable Long entityId,
            @PathVariable List<String> noteTypes
    ) {
