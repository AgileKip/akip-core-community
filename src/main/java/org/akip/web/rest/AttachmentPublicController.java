...
public class AttachmentPublicController {

    private final Logger log = LoggerFactory.getLogger(AttachmentPublicController.class);
    ...
    public AttachmentPublicController(AttachmentService attachmentService) {
        this.attachmentService = attachmentService;
    }

    @PostMapping("/attachments")
    public ResponseEntity<Void> create(@PathVariable String accessToken, @RequestBody List<AttachmentDTO> attachmentsDTO)
    ...
    public ResponseEntity<Void> update(@PathVariable String accessToken, @RequestBody AttachmentDTO attachmentDTO)
        throws URISyntaxException {
    ...
    public ResponseEntity<AttachmentDTO> get(@PathVariable String accessToken, @PathVariable Long attachmentId) {
    ...
    public ResponseEntity<Void> delete(@PathVariable String accessToken, @PathVariable Long attachmentId) {
        log.debug("REST request to get attachment: {}", attachmentId);
    ...
    public List<AttachmentDTO> getAttachmentsByEntityNameAndEntityId(
        ...
        log.debug("REST request to getAttachmentsByEntityNameAndEntityId: entityName={}, entityId={}", entityName, entityId);
